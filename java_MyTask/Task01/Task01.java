...
public class Task01 {
    ...
    public static void main(String[] args) {
        ...
        /*Soru-4 : "Basari" gayreti 'sever'  yazdırınız sonraki "Clarusway ile java cok kolay ..." ifadesi
   ...
   /*
        ...
        System.out.println("Burak Ercan" + "\n" + 1.78 + "\n" + 78 + "\n" + "Binicilik, Dalış, Netflix");
    }
}
